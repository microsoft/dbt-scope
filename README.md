...
{{ config(
    ...
    max_bytes_per_trigger=107374182400,  -- 100 GB
...
| `max_bytes_per_trigger`      | `107374182400` (100 GB) | Max estimated bytes per batch. Works alongside `max_files_per_trigger` — whichever limit is hit first stops the batch. Estimates account for SSv5/v6 `.du` sibling folders (see below) |
